<div class="sidebar-page">
    <div class="widget widget-category">
        ...
        <?php
        $sql = new LandaDb();
        $kategori = $sql->findAll("SELECT m_kategori.name as kategori, m_kategori.alias, count(artikel.id) as total FROM m_kategori left join artikel ON artikel.m_kategori_id = m_kategori.id WHERE m_kategori.id in (4, 5, 6, 7, 8, 9) group by m_kategori.id");
        ?>
        <ul class="category">
            <?php
