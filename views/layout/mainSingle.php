...
<html>
<head>
    <title><?= isset($_title) ? $_title : config('blog.title') ?></title>
    <meta charset="UTF-8">
    ...
    <?php
    if (isset($_gallery)) {
        echo '<link rel="stylesheet" href="' . site_url() . 'css/jquery.bsPhotoGallery.css">';
    } else {
        echo '<link rel="stylesheet" href="' . site_url() . 'css/owl.carousel.min.css">';
        echo '<link rel="stylesheet" href="' . site_url() . 'css/owl.theme.default.min.css">';
    }
    ?>
    ...
    <style>
        ...
        .se-pre-con {
            ...
            height: 100%;
            z-index: 9999;
            background: url("<?= site_url() ?>/app/img/logo-circle.png") center no-repeat #000;
            opacity: 0.94;
        }
    </style>
</head>
...
<div id="page" class="boxed">
    ...
    <?php echo partial('layout/footer', array('setting' => $setting)) ?>
</div>
<a id="to-the-top" class="fixbtt" style="display: inline;"><i class="glyphicon glyphicon-chevron-up"></i></a>
</body>
<script>
 ...
 */
    ...
    $(document).ready(function () {
        "use strict";
        $("ul.navi-level-1 li").hover(function () {
            $(this).children("ul.navi-level-2").addClass("open-navi-2 animated fadeInUp")
        }, function () {
            $(this).children("ul.navi-level-2").removeClass("open-navi-2 animated fadeInUp")
        }), $(".has-sub").click(function () {
            return $(this).children("ul.navi-level-2").toggleClass("open-navi-2 animated"), !1
        })
    });
    var elementPosition = $("#page-header").offset();
    $(window).scroll(function () {
        $(window).scrollTop() > elementPosition.top ? $("#page-header").addClass("header-fixed") : $("#page-header").removeClass("header-fixed")
    });
    var offset = 450, duration = 500;
    $(window).on("scroll", function () {
        $(this).scrollTop() > offset ? $("#to-the-top").fadeIn(duration) : $("#to-the-top").fadeOut(duration)
    }), $("#to-the-top").on("click", function (a) {
        return a.preventDefault(), $("html, body").animate({scrollTop: 0}, duration), !1
    }), $(".btn-search-navi").click(function () {
        return $(".search-popup").toggleClass("open-search-input animated fadeInUp"), $(".btn-search-navi .fa-search").toggleClass("fa-remove"), $(".btn-search-navi").toggleClass("active"), !1
    }), $("#menu-mobile").click(function () {
        return $(".navi").toggleClass("navi-open fadeInUp"), !1
    });
</script>
...
if (isset($_gallery)) {
    ?>
    <script src="<?= site_url() ?>js/jquery.bsPhotoGallery.js"></script>
    <script>
        $(document).ready(function () {
            $('ul.first').bsPhotoGallery({
                "classes": "col-lg-3 col-md-6 col-sm-12 col-xs-6 col-xxs-12",
                "hasModal": false
            });
        });
        $(document).ready(function () {
...
?>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/ekko-lightbox/5.3.0/ekko-lightbox.min.js" type="application/javascript"></script>
