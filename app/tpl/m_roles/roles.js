app.controller('approlesCtrl', function ($scope, Data, toaster) {
    //init data
    var tableStateRef;
    ...
    $scope.is_edit = false;
    $scope.is_view = false;
    Data.get('approles/kategori').then(function (data) {
    ...
    $scope.callServer = function callServer(tableState) {
        ...
        Data.get('approles/index', param).then(function (data) {
    ...
    $scope.update = function (form) {
        ...
        $scope.form = form;
        Data.get('approles/view/'+form.id).then(function (data) {
    ...
    $scope.save = function (form) {
        ...
        // var url = (form.id > 0) ? 'approles/update/' + form.id : 'approles/create/';
        var url = 'approles/create/';
    ...
    $scope.delete = function (row) {
        if (confirm("Apa anda yakin akan MENGHAPUS PERMANENT item ini ?")) {
            Data.delete('approles/delete/' + row.id).then(function (result) {
    ...
    $scope.checkAll = function (module, valueCheck) {
        ...
        var akses = {
            "master_akses": false,
            "master_user": false,
            "master_artikel": false,
            "master_setting": false,
            "master_filemanager": false,
        };
